                    ...
                    <div className='bg-white rounded-md p-5'>
                        ...
                        <div className='flex flex-wrap items-center justify-between w-full gap-2'>
                            <div className='w-full md:w-[30%] lg:w-[30%]'>
                                ...
                                />
                                <button onClick={() => setReturnAtDifferent(true)} className='py-1 mt-1 px-3 bg-blue-800 text-white rounded-md'>I want to deliver in a different place</button>
                            </div>

                            <div className='flex flex-wrap items-center justify-between gap-3 w-full md:w-[30%] lg:w-[30%]'>
                                <div className='w-[48%]'>
                                ...
                                returnAtDifferent ?
                                    <div className='mt-3'>
                                        ...
                                        <Autocomplete
                                            ...
                                            value={location}
                                            onChange={(e) => setLocation(e.target.value)}
                                            className="border-2 rounded-[5px] p-1 w-full outline-none md:w-[30%]"
                                        />
                                    </div> : null
                            }
                        </div>
                        ...
                        <div className='w-full text-center'>
                            <button className='p-2 px-8 bg-blue-500 text-white font-bold rounded-md mt-3 w-full md:w-auto'>Search</button>
                        </div>
                    </div>
